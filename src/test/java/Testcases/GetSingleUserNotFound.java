...
public class GetSingleUserNotFound {
	@Test
	public void getSingleUseNotFound() throws BiffException, IOException {
		...
		String endpoint = j.readexcel(7, 28);
		...
		if (response.getStatusCode() == 404) {
			j.writexcel("TestCase", 12, 10, "passed");
		} else {
			j.writexcel("TestCase", 12, 10, "failed");
		}
	}
}
